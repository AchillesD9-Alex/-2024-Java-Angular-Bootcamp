...
public class ClassStock {
    ...
    static List<ClassStock> inventario = new ArrayList<>();
    ...
    public ClassStock(String nombre, double precioBruto, double IVA, int cantidad) {
        this.nombre = nombre;
...
//  METODOS
    public static void agregarArticulo() {
        ...
        ClassStock producto = new ClassStock(nombre, precioBruto, IVA, cantidad);
    ...
    public static void eliminarArticulo() {
        ...
        Iterator<ClassStock> iterator = inventario.iterator();
        while (iterator.hasNext()) {
            ClassStock producto = iterator.next();
    ...
    public static ClassStock buscarArticulo(String nombre) {
        for (ClassStock producto : inventario) {
 ...
 // Va pidiendo los artículos conforme pasan por caja
    public static void comprarArticulos(Scanner sc, HashMap<String, Double[]> compra) {
        ...
        do {
            ...
            ClassStock articulo = buscarArticulo(nombreProductoComprado);
