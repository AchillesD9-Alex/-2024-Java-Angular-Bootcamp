...
public class MainStock {
    ...
    static List<MainStock> inventario = new ArrayList<>();
    ...
    public MainStock(String nombre, double precioBruto, double IVA, int cantidad) {
        this.nombre = nombre;
    ...
    public static void agregarArticulo() {
        ...
        MainStock producto = new MainStock(nombre, precioBruto, IVA, cantidad);
    ...
    public static void eliminarArticulo() {
        ...
        Iterator<MainStock> iterator = inventario.iterator();
        while (iterator.hasNext()) {
            MainStock producto = iterator.next();
    ...
    public static MainStock buscarArticulo(String nombre) {
        for (MainStock producto : inventario) {
            if (producto.nombre.equalsIgnoreCase(nombre)) {
                return producto;
            }
        }
    ...
    public static void main(String[] args) {
        MainStock leche = new MainStock("LECHE", 1.10, 4, 20);
        	inventario.add(leche);
        MainStock pan = new MainStock("PAN", 0.90, 4, 30);
        	inventario.add(pan);
        MainStock huevos = new MainStock("HUEVOS", 2.50, 4, 40);
        	inventario.add(huevos);
        MainStock arroz = new MainStock("ARROZ", 1.30, 21, 15);
        	inventario.add(arroz);
        MainStock pasta = new MainStock("PASTA", 1.25, 21, 25);
        	inventario.add(pasta);
        MainStock tomates = new MainStock("TOMATES", 2.35, 21, 35);
        	inventario.add(tomates);
        MainStock patatas = new MainStock("PATATAS", 2.10, 21, 10);
        	inventario.add(patatas);
        MainStock manzanas = new MainStock("MANZANAS", 1.75, 21, 45);
 ...
 // Va pidiendo los artículos conforme pasan por caja
    public static void comprarArticulos(Scanner sc, HashMap<String, Double[]> compra) {
        ...
        do {
            ...
            MainStock articulo = buscarArticulo(nombreProductoComprado);
