...
public class Test4 {
	public static void main (String args[]){
		...
		for(int i=0; i<6; i++)
			...
			//Elimino */ ya que no tiene sentido y genera error, aunque era para poner un comentario,
				//pero he decidido borrarlo porque yo ya pongo bastantes
		...
		System.out.println(i);
			...
			//Cambio print a printlr para que los valores de la variable i salgan con el enter
				//y no todo seguidos en la misma línea de la consola

		System.out.println("FIN DE PROGRAMA"); //Avisa de finalización de todo lo demás,
											//ya que es la última línea del programa que se ejecuta
